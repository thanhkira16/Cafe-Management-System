...
//	public static SimpleDateFormat formatter = new SimpleDateFormat("[MM/hh/yy hh:mm a]");
	...
	private static void broadcastMessage(Product message) throws ClassNotFoundException, IOException {

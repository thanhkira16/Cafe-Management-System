...
public class UserDao {
    ...
    public static boolean emailExists(String email) {
        try {
            ResultSet rs = DbOperation.getData("SELECT COUNT(*) FROM user WHERE email = ?");
            rs.next();
    ...
    public class UserDAO {
        // Các phương thức khác của lớp UserDAO
...
//            PreparedStatement statement = null;
            ...
            try {
                 resultSet = DbOperation.getData("select *from user where email = '" + email + "'");
            ...
            return false; // Trả về giá trị mặc định nếu không tìm thấy người dùng hoặc xảy ra lỗi
        }
    }
